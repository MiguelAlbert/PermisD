...
public class Manoeuvres8_10Fragment04 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.manoeuvres_fragment8_10_04,container,false);
        ...
        imageView.setImage(ImageSource.resource(R.drawable.d4));
