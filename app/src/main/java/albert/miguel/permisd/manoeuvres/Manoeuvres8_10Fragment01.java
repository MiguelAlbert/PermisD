...
public class Manoeuvres8_10Fragment01 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View v = inflater.inflate(R.layout.manoeuvres_fragment8_10_01,container,false);
        ...
        imageView.setImage(ImageSource.resource(R.drawable.d1));
